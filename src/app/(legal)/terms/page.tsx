...
export default function TermsPage() {
  return (
    <LegalShell title="Terms of Service" updated="June 12, 2026">
      <p>
        These Terms govern your use of Nxelio. By creating an account you agree to them. If you are using
        Nxelio on behalf of an organization, you agree on its behalf.
      </p>
      ...
      <p>
        You agree to use Nxelio only for lawful outreach to contacts you have a legitimate basis to email.
      ...
      <p>
        You retain ownership of the leads, copy, and other content you put into Nxelio. You grant us the
      ...
      <p>
        We work to keep Nxelio available but provide the service &quot;as is&quot; without warranty of
      ...
      <h2>6. Termination</h2>
      <p>
        You may stop using Nxelio and delete your workspace at any time. We may suspend accounts that violate
        these Terms.
      </p>
