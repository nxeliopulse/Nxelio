    ...
    <div className="force-light-theme min-h-screen bg-slate-50">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:py-12">
        <div className="flex gap-10 items-start">
          ...
          <div className="hidden lg:block w-[460px] flex-shrink-0 sticky top-12 mt-20">
            <div className="relative rounded-3xl overflow-hidden shadow-xl flex items-center justify-center p-10 h-[68vh] max-h-[620px]"
            ...
            <p className="mt-4 text-center text-sm text-slate-400 px-2">
