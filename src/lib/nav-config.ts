import { LayoutDashboard, Users2, Send, Layers3, Briefcase, BarChart3, Inbox, Newspaper, UserCog, Settings, Link2, BookOpen } from "lucide-react";
...
export const navMainItems: NavItem[] = [
  ...
  { label: "Playbooks", href: "/playbooks", icon: BookOpen, roles: ALL },
