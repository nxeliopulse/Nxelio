...
/**
 * Unified "Connectors" panel — Email, LinkedIn, and Calendar in one place.
...
export function ConnectorsView({
  ...
  return (
    <div className="space-y-4">
      <Card className="p-6">
        <h3 className="font-semibold text-slate-900 mb-1">Connectors</h3>
        <p className="text-sm text-slate-500">
          Connect your email, LinkedIn, and calendar so campaigns can send on your behalf, replies land in your Inbox, and meetings sync automatically.
        </p>
      </Card>
