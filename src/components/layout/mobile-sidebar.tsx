      ...
      >
        ...
        <div className="p-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
          <Link
            ...
            className="block bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl p-2.5 text-white shadow-sm hover:opacity-95 transition-opacity"
          >
            <div className="flex items-center justify-between gap-1.5 mb-1.5">
              <div className="flex items-center gap-1.5">
                <Sparkles className="h-3.5 w-3.5 text-white/90 flex-shrink-0" />
