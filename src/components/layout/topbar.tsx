...
import { ChevronDown, LogOut, User as UserIcon, Settings, Menu, Sparkles } from "lucide-react";
    ...
    <header className="h-16 bg-slate-50 px-3 sm:px-4 lg:px-6 flex items-center justify-between gap-2 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 rounded-2xl font-bold text-sm transition-all flex-shrink-0 px-3 sm:px-4 h-11 text-white bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-500 shadow-md shadow-blue-500/25 ${
        ...
        <div className="relative" ref={ref}>
          <button
            ...
            className="flex items-center gap-2 pl-1 pr-1 sm:pr-2 py-1 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800"
          >
            <div className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-xs flex-shrink-0 shadow-xs">
              {initials}
            </div>
