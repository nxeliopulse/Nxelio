...
export function LeadDetailView({
  ...
  // Earliest upcoming follow_up_date across this lead's opportunities — the
  // only real "next follow up" concept in the schema (leads have none of
  // their own). Null when no opportunity has one set.
  const nextFollowUpDate = opportunities
    .map((o) => o.follow_up_date)
          ...
          <Card className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm rounded-xl">
            ...
            <div className="border-b border-slate-100 dark:border-slate-800 pb-3 mb-3 space-y-2">
              ...
              <div className="flex justify-between items-center text-xs py-1">
                ...
                <p className="text-slate-800 dark:text-slate-700 font-semibold">
                  {nextFollowUpDate ? formatDate(nextFollowUpDate) : "—"}
                </p>
              </div>
              <div className="flex justify-between items-center text-xs py-1">
