...
import type { MeetingsFilters, MeetingsAnalyticsData } from "@/lib/queries/analytics-meetings";
...
export function MeetingsFilterBar({ filters, data }: { filters: MeetingsFilters; data: MeetingsAnalyticsData }) {
